    ...
    void generateWorkoutPlan(string goal, int days) {
        ...
        if (goal == "weight loss") {
            ...
            for (int i = 1; i <= days; i++) {
                cout << "\nDay " << i << ": ";
                if (i % 2 == 0) cout << "30 min Running + 20 min Weight Training" << endl;
                else cout << "45 min Cycling + Core Exercises" << endl;
            }
        } else {
            cout << "\nFocus: Strength training with progressive overload" << endl;
            for (int i = 1; i <= days; i++) {
                cout << "\nDay " << i << ": ";
                if (i % 2 == 0) cout << "Upper Body (Push-ups, Pull-ups, Bench Press)" << endl;
                else cout << "Lower Body (Squats, Deadlifts, Lunges)" << endl;
            }
        }
